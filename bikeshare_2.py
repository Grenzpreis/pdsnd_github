...
def get_filters():
    ...
    while city != "chicago" and city != "new york city" and city != "washington":
        city = input("Please choose a city to load from(chicago, new york city, washington):")
    ...
    while month != "all" and month != "january" and month != "february" and month != "march" and month != "april" and month != "may" and month != "june":
        month = input("Please choose a month (in case you want to filter on all month choose 'all'):")
    ...
    while day != "all" and day != "monday" and day != "tuesday" and day != "wednesday" and day != "thursday"and day != "friday"and day != "saturday"and day != "sunday":
        day = input("Please choose a day (in case you want to filter on all days choose 'all'):")
...
def station_stats(df):
    ...
    print("Most Commonly Used Combination Of Start And End Station: " + df['Combined Station'].mode()[0])
...
def user_stats(df):
    ...
    print("Latest Year of Birth: " + str(int(df['Birth Year'].max())))
